...
`payment_raiffeisen/raiaccept.py` deliberately imports nothing from
...
FIXTURES = ROOT / "payment_raiffeisen" / "tests" / "fixtures"

_spec = importlib.util.spec_from_file_location(
    "raiaccept", ROOT / "payment_raiffeisen" / "raiaccept.py"
)
...
def manifest():
    ...
    text = (ROOT / "payment_raiffeisen" / "__manifest__.py").read_text(
        encoding="utf-8"
    )
